                ...
                <div className='w-full px-3 sm:px-4 xl:w-1/2'>
                  <div className='relative z-10 my-4'>
                    <img
                      ...
                      className='w-full rounded-2xl'
                    />
                    <span className='absolute text-green-600 -right-7 -bottom-7 z-[-1]'>
                      <svg
                        width={134}
                        height={106}
                        viewBox='0 0 134 106'
            ...
            <div className='w-full px-4 lg:w-1/2 xl:w-5/12'>
              <div className='mt-10 lg:mt-0'>
                ...
                <p className='mb-8 text-base text-body-color dark:text-dark-6'>
                  ...
                  great but also perform exceptionally well. As a{" "}
                  <b>React.js developer</b>, I excel at creating
                  high-performance user interfaces that engage and delight
                  users.
                </p>
                <p className='mb-8 text-base text-body-color dark:text-dark-6'>
                  ...
                  that allows me to grow and make a difference. If you’re
                  looking for a reliable <b>freelance web developer</b> to bring
                  your project to life, I’m here to help.
                </p>
                <p className='mb-8 text-base text-body-color dark:text-dark-6'>
                  When I’m not coding, you’ll likely find me exploring creative
                  ideas, learning new technologies, or brainstorming ways to
                  help local businesses and international clients succeed
                  online.
                </p>
                <p className='mb-8 text-base text-body-color dark:text-dark-6'>
                  Let’s work together to bring your vision to life and make an
